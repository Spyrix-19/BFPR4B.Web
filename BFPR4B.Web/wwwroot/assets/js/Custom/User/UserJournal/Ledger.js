...
var KTDatatablesJournal = function () {
    ...
    var initDatatable = function () {
        ...
        dt = $("#kt_table_user_journal").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: false,
            order: [],
        ...
        $('[data-kt-user-journal-table-search="search"]').on('click', resetSearch);
    ...
    return {
        init: function () {
            ...
            let modal = document.getElementById('kt_modal_user_journal');
