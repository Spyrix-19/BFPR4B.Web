...
var KTDatatablesJournal = function () {
    ...
    var initDatatable = function () {
        ...
        dt = $("#kt_table_office_journal").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: false,
            order: [],
        ...
        $('[data-kt-office-journal-table-search="search"]').on('click', resetSearch);
    ...
    return {
        init: function () {
            ...
            let modal = document.getElementById('kt_modal_office_journal');
